        ...
        <section class="content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    {{-- form input data --}}
                    <form action="{{ route('detail_barang_keluars.update', $detail_barang_keluar->id) }}" method="POST">
                        @method('PUT')
                        @csrf
                        <div class="row">
                            {{-- kolom barang --}}
                            ...
                            <div class="col-lg-2">
                                <div class="form-group">
                                    ...
                                    <input min="0" class="form-control @error('jumlah') is-invalid @enderror"
                                        type="number" placeholder="Jumlah Barang Keluar" name="jumlah"
                                        value="{{ old('jumlah', $detail_barang_keluar->qty) }}" required maxlength="4"
                            ...
                            <div class="col-lg-2">
                                <div class="form-group">
                                    ...
                                    <input name="harga" min="3"
                                        ...
                                        value="{{ old('harga', $detail_barang_keluar->harga_beli) }}" required
                                        maxlength="20"
                                        oninput="if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                    @error('harga')
                                        <span class="text-danger">{{ $message }}</span>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $detail_barang_keluar->qty }}"
                                ...
                                <div class="form-group col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ $detail_barang_keluar->harga_beli }}" name="hidden_harga" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
